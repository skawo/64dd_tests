...
VERSIONED_TABLE(PlaySfx_Table,    (void*)0x800C806C, (void*)0x800C823C, NULL, (void*)0x800C88BC);
VERSIONED_TABLE(ActorSpawn_Table, (void*)0x80025110, (void*)0x80025110, NULL, (void*)0x80025750);
VERSIONED_TABLE(bcopy_Table,      (void*)0x80004DC0, (void*)0x80004DC0, NULL, (void*)0x80004FD0);
...
void Audio_PlaySfxGeneral_Versioned(u8 gameVer, u16 sfxId, Vec3f* pos, u8 token, f32* freqScale, f32* vol, s8* reverbAdd)
{
    ...
    VERSIONED_CALL(PlaySfx_Table, gameVer - 1, PlaySfxFunc, sfxId, pos, token, freqScale, vol, reverbAdd);
}
...
void Actor_Spawn_Versioned(u8 gameVer, ActorContext* actorCtx, PlayState* play, s16 actorId, f32 posX, f32 posY, f32 posZ, s16 rotX, s16 rotY, s16 rotZ, s16 params)
{
    ...
    VERSIONED_CALL(ActorSpawn_Table, gameVer - 1, ActorSpawnFunc, actorCtx, play, actorId, posX, posY, posZ, rotX, rotY, rotZ, params);
}

void bcopy_Versioned(u8 gameVer, const void* __src, void* __dest, int __n)
{
    typedef void (*bcopyFunc)(const void*, void*, int);
    VERSIONED_CALL(bcopy_Table, gameVer - 1, bcopyFunc, __src, __dest, __n);
}